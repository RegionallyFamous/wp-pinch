...
/**
 * Analytics ability execution methods.
 */
trait Analytics_Execute_Trait {
	...
	public static function execute_related_posts( array $input ): array {
		...
		if ( ! empty( $term_taxonomy_ids ) ) {
			...
			$by_taxonomy_ids = $wpdb->get_col(
				$wpdb->prepare(
					// phpcs:disable WordPress.DB.PreparedSQL -- $in_placeholders is placeholder list only ('%d,%d'); values in array_merge.
