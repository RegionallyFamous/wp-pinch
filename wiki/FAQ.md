...
WP Pinch passes PHPCS (WordPress-Extra + Security), PHPStan Level 6, and 372 PHPUnit tests. Every ability has security guards, every input is sanitized, every output is escaped. It's as battle-tested as a lobster that survived the tank at Red Lobster.
